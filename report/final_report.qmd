...
As shown in @fig-llm-pipeline, the pipeline consists of multiple stages, integrating both deterministic and AI-driven components.
...
1. **A34(1) Refusals by Country and Ground**  
    - *Insight*: A34(1)(f), was the most cited inadmissibility ground, with Ukraine and Syria showing major spikes as seen in @fig-a34-refusals
...
2. **Litigation Outcomes by Region and Country**  
   - *Insight*: Nigeria dominated RAD appeals; Iran had a spike in visa refusals post-2020 as shown in @fig-litigation-outcomes
...
You can see the snapshot of the dashboard in @fig-dash-board with the above mentioned design priorities being shown.
